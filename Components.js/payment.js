...
const Payments = ({ isDarkMode }) => {
  ...
  return (
      ...
      <Image source={require('../assets/send.png')} color={isDarkMode ? '#fff' : '#000'} top={18} size={24}/>
        <Text style={textTypeStyle}>Sent</Text>
      </View>
      <View style={[searchContainerStyle, { marginHorizontal: 12}]}>
      <Image source={require('../assets/receive.png')} color={isDarkMode ? '#fff' : '#000'} top={18} size={24}/>
